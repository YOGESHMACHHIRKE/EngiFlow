              ...
              <div className="flex justify-between items-start">
                  <div>
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white break-all">
                      {document.name}
                      <span className="ml-3 text-base font-medium text-gray-500 dark:text-gray-400">v{document.version}</span>
                    </h2>
                    <p className="text-sm text-gray-500 dark:text-gray-400">ID: {document.id}</p>
                  </div>
                   <div className={`ml-4 flex-shrink-0 px-4 py-2 text-sm font-semibold rounded-full flex items-center ${bg} ${text}`}>
             ...
             <div className="p-6 border-t dark:border-gray-700">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-3 rounded-lg shadow-md transition-transform transform hover:scale-105 disabled:bg-blue-400 disabled:cursor-not-allowed text-sm"
                  >
            ...
            <div className="p-6 border-t dark:border-gray-700">
              ...
              <div className="space-y-2 max-h-72 overflow-y-auto pr-2 -mr-2">
                {document.history.map((entry, index) => {
                  ...
                  const userAvatarUrl = entryUser?.photoUrl || `https://i.pravatar.cc/150?u=${entryUser?.email || entry.user}`;
